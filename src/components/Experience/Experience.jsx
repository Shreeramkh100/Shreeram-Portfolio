        ...
        <Element name="experience">
            <div id="experience"> 
                ...
                <ul className='flex justify-center items-center flex-wrap md:py-3'>
                    {experience && experience.map((company, id) => (
                        <li key={id} className='border-2 bg-white shadow-custom_shadow shadow-blue-500 flex items-center w-[343px] h-[200px] px-2 m-2 rounded-2xl lg:h-[220px] lg:w-[440px] lg:px-2 lg:py-2'>
